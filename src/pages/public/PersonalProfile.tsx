    ...
    <PublicLayout>
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="container grid grid-cols-1 gap-6 p-6 mx-auto md:grid-cols-3">
          <aside
            className="p-4 bg-white rounded-lg shadow-lg md:col-span-1"
            aria-label="Sidebar"
          >
            <div className="flex items-center mb-4">
              ...
              <div className="ml-4">
                <h2 className="text-xl font-semibold text-gray-800">
                  {userResponse?.nombres} {userResponse?.apellidos}
                </h2>
                ...
                <div className="flex mt-2 space-x-2">
                  ...
                  <button className="px-4 py-2 text-blue-700 border border-blue-700 rounded-md">
                    Diseñar CV
                  </button>
                </div>
              </div>
            ...
            <div className="p-4 mt-4 bg-white rounded-lg shadow-md">
              ...
              <div className="p-4 mt-4 rounded-lg shadow-md bg-blue-50">
                ...
                <ul className="text-gray-600 list-disc list-inside">
                  ...
                  <li>
                    Incluye habilidades relevantes a los trabajos que buscas.
                  </li>
